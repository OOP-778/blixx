...
public class StyleBuilder {
    ...
    static boolean nothingToMerge(
            final @NotNull Style mergeFrom,
            final Style.Merge.@NotNull Strategy strategy,
            final @NotNull Set<Style.Merge> merges) {
    ...
    public @NotNull StyleBuilder merge(
            final @NotNull Style that,
            final Style.Merge.@NotNull Strategy strategy,
            final @NotNull Set<Style.Merge> merges) {
        ...
        if (merges.contains(Style.Merge.COLOR)) {
            ...
            if (color != null) {
                if (strategy == Style.Merge.Strategy.ALWAYS
                        || (strategy == Style.Merge.Strategy.IF_ABSENT_ON_TARGET && this.color == null)) {
                    this.color(color);
                }
            }
        }
        ...
        if (merges.contains(Style.Merge.EVENTS)) {
            ...
            if (clickEvent != null) {
                if (strategy == Style.Merge.Strategy.ALWAYS
                        || (strategy == Style.Merge.Strategy.IF_ABSENT_ON_TARGET && this.clickEvent == null)) {
            ...
            if (hoverEvent != null) {
                if (strategy == Style.Merge.Strategy.ALWAYS
                        || (strategy == Style.Merge.Strategy.IF_ABSENT_ON_TARGET && this.hoverEvent == null)) {
        ...
        if (merges.contains(Style.Merge.INSERTION)) {
            ...
            if (insertion != null) {
                if (strategy == Style.Merge.Strategy.ALWAYS
                        || (strategy == Style.Merge.Strategy.IF_ABSENT_ON_TARGET && this.insertion == null)) {
                    this.insertion(insertion);
                }
            }
        }
        ...
        if (merges.contains(Style.Merge.FONT)) {
            ...
            if (font != null) {
                if (strategy == Style.Merge.Strategy.ALWAYS
                        || (strategy == Style.Merge.Strategy.IF_ABSENT_ON_TARGET && this.font == null)) {
                    this.font(font);
                }
            }
        }
    ...
    public @NotNull Style build() {
        ...
        if (STYLE_CONSTRUCTOR_ARGS_COUNT == 6) {
            return (Style) CREATE_STYLE_HANDLE.invoke(
                    this.font, this.color, this.decorations, this.clickEvent, this.hoverEvent, this.insertion);
        }

        if (STYLE_CONSTRUCTOR_ARGS_COUNT == 7) {
            return (Style) CREATE_STYLE_HANDLE.invoke(
                    this.font, this.color, null, this.decorations, this.clickEvent, this.hoverEvent, this.insertion);
        }
