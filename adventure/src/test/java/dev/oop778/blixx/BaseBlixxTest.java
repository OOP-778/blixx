...
public class BaseBlixxTest {
    ...
    protected void compareComponents(Component expected, Component given) {
        ...
        final String expectedString =
                LegacyComponentSerializer.legacyAmpersand().serialize(expected);
    ...
    protected void componentSerializesTo(String expectedString, BlixxComponent given) {
        final String givenString =
                LegacyComponentSerializer.legacyAmpersand().serialize(AdventureBlixxComponent.asComponent(given));
        assertEquals(expectedString, givenString);
    }
}
