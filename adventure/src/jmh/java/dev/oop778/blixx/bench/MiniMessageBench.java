...
public class MiniMessageBench {
    ...
    public void setup() {
        ...
        this.blixxWithKeys = Blixx.builder()
                .withStandardParserConfig((configurator) ->
                        configurator.withTags(BlixxTags.STANDARD).withPlaceholderFormat('<', '>'))
    ...
    public void parseReplaceToComponent() {
        ...
        AdventureBlixxComponent.asComponent(this.blixxWithKeys
                .parseComponent(this.complexInput)
                .replace(placeholders, PlaceholderContext.create()));
    }
